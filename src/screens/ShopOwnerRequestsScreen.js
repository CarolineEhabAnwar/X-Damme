...
export default class SORequestScreen extends Component {
  render() {
    return (
      <Container>
        <Content>
          <Card style={{marginTop:60,flex: 0}}>
            <Image source={require("../../assets/motor.png")} style={{marginBottom:20,height: 200, width: null}}/>
              <CardItem style={{marginHorizontal:1,borderWidth:3,borderColor:'#bab5b5'}}>
                <Body>
                  ...
                  <View style={{flexDirection:'row',marginTop:17, marginLeft:'15%'}}>
                    {/* Accept */}
                    <Button style={{marginLeft:20,backgroundColor:'green'}}>

...
const MyCarsScreen = () => {
    ...
    return (
      <Container>
        ...
        <Button style={{marginLeft:'auto',alignSelf:'center'}} transparent  onPress={() => this.props.navigation.navigate('AddCar')}>
      ...
      <Content>
          <List>
            <ListItem>
              <Button transparent onPress={() => this.props.navigation.navigate('MyCarsDetails')}>
                <Ionicons name="car" style= {{marginRight:-5}} size={27} color="darkred" />
                <Text style={{color:'darkred',fontSize:18,fontWeight:'500'}}>Renault Logan 2008</Text>
              </Button>

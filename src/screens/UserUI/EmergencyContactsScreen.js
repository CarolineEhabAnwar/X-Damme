  ...
  return (
    <Container >
      ...
      <View searchBar style={{ flexDirection: 'row', paddingTop: 25, marginBottom: 12, paddingBottom: 6, alignContent: "center", backgroundColor: "darkred", top: 0 }}>
        ...
        <Text style={{ color: "white", height: 50, fontSize: 20, textAlign: 'center', paddingLeft: '16%', paddingTop: 12, fontWeight: 'bold' }}>{t('UserEmergencyContactsScreenTitle')}</Text>
      </View>
                ...
                <Right>
                  <View style={{ flexDirection: 'row', justifyContent: "flex-start" }}>
                    ...
                    >
                      ...
                      <Text style={{ color: 'white', fontWeight: 'bold' }}>{t('UserEmergencyContactsScreenButton1')}</Text>
                    </Button>
                  </View>
                </Right>
              </ListItem>
...
export default EmeregencyContactsScreen;

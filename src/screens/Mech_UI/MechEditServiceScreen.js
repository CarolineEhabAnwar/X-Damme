...
export default class MechEditServiceScreen extends Component {
    ...
    return (
      ...
      <View searchBar style={{flexDirection: 'row', paddingTop:26 , marginBottom: 3, paddingBottom: 6, alignContent:"center", backgroundColor: "darkgreen", top: 0}}>
        <Button transparent onPress={() => this.props.navigation.navigate('MechServiceList')} >
          ...
          <Text style={{color: "white",height:50,fontSize:20, textAlign:'center',paddingLeft:'21%',paddingTop:12, fontWeight:'bold'}}> Edit Service</Text> 
      </View>
      {/* End Search bar with drawer */}  
        ...
        <View style={{flexDirection:'row'}}>
          ...
          <Text style={styles.textStyle}>Please enter service's new details</Text>
        </View>
        <Form>          
        ...
        <Picker
            ...
            >
              <Picker.Item label="Mechanic" value="key0" />
              <Picker.Item label="Electrican" value="key1" />
              <Picker.Item label="Fix Motors" value="key2" />
        </Picker>
        </Item>
        ...
        <View style={{flexDirection:'row',justifyContent:'center'}}>
          ...
          <Button bordered onPress={() => this.props.navigation.navigate('MechServiceList')} style={{borderColor:'darkgreen',marginVertical:20, alignSelf:'center'}}>
              <Text style={{color:'darkgreen'}}>Cancel</Text>
          </Button>
        </View>

        <View style={{flexDirection:'col',justifyContent:'center'}}>
          <Text style={{color:'darkgreen',fontSize:19,alignSelf:'center',fontWeight:'600'}}>OR</Text>
          <Button style={{backgroundColor:'darkgreen', marginVertical:20, alignSelf:'center',flexDirection:'row'}} onPress={() => this.props.navigation.navigate('MechAddOffer')}>
            <FontAwesome name="percent" style={{marginLeft:10,marginRight:-9}} size={19} color="white" />
            <Text>Add offer to this service</Text>
          </Button>
        </View>

  ...
  render() {
    ...
    return (
      <Container>
        ...
        <Button transparent onPress={() => this.props.navigation.navigate('MechRequests')} >
              <Ionicons
                name='arrow-back-outline'
                style={{ fontSize: 30, marginTop:4,marginRight:12,marginLeft:12 ,color: 'white'}}
              />
        </Button>
            <Text style={{color: "white",height:50,fontSize:20, textAlign:'center',paddingLeft:'18%',paddingTop:12, fontWeight:'bold'}}> Service Details</Text> 
        </View>
